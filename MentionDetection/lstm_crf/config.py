...
# 希望做命名识别的数据
tf.app.flags.DEFINE_string("pred_file", 'resource/test_predict.txt', "test data.")
tf.app.flags.DEFINE_string("src_vocab_file", 'resource/train_source_vocab.txt', "source vocabulary.")
tf.app.flags.DEFINE_string("tgt_vocab_file", 'resource/train_target_vocab.txt', "targets.")
